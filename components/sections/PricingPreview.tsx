          ...
          {plans.map((plan, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-lg font-black text-white uppercase italic tracking-widest">{plan.name}</h3>
                  <p className="text-[10px] text-white/40 uppercase tracking-widest mt-1 max-w-60">{plan.description}</p>
                </div>
                {plan.isPopular && (
              ...
              <div className="mb-8">
                ...
                <span className="text-[10px] text-white/20 uppercase ml-2 tracking-widest">
                  {plan.period}
                </span>
              </div>
              ...
              <NextLink href="/pricing" className="block w-full">
                <button 
